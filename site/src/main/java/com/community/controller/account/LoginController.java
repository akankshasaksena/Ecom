...
import com.community.controller.account.dto.HCRegisterCustomerForm;
...
public class LoginController extends BroadleafLoginController {
    ...
    public String login(HttpServletRequest request, HttpServletResponse response, Model model) {
        ...
        HCRegisterCustomerForm registerForm=new HCRegisterCustomerForm();
        registerForm.setCustomer(registrationForm.getCustomer());
